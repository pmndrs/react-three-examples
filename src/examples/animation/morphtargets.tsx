 ...
 * - A point light attached to the camera as a "headlight", declaratively:
...
export default function MorphTargets() {
  return (
    <Canvas renderer background="#8fbcd4">
      {/* Declarative headlight: the child light is the JSX form of camera.add(light). */}
      <PerspectiveCamera makeDefault position={[0, 0, CAMERA_DISTANCE]} fov={45} near={1} far={20}>
        <pointLight color="#ffffff" intensity={200} />
      </PerspectiveCamera>
