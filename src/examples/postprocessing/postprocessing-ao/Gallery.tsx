...
export function Gallery() {
  ...
  // REVIEW(shared-instance): wall material spans 3 meshes, column material spans every
  // Column — a JSX child would create one each. Shared instance is correct for
  // performance; worth checking whether the columns want <Instances>.
