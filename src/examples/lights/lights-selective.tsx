...
function Teapots({ light1Ref, light2Ref }: TeapotsProps) {
  const { roughness, metalness } = useControls('lights-selective', {
    center: folder({
  ...
  return (
    <Canvas
      ...
      <Suspense fallback={null}>
        <Teapots light1Ref={light1Ref} light2Ref={light2Ref} />
      </Suspense>
