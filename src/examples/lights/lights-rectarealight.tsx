...
function RectAreaLights() {
  const { speed, intensity, width, height, helpers } = useControls('lights-rectarealight', {
    lights: folder({
...
function Floor() {
  const { checkerScale } = useControls('lights-rectarealight', {
    floor: folder({
...
function Knot() {
  const { roughness, metalness } = useControls('lights-rectarealight', {
    knot: folder({
