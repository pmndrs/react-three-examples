...
export function SnowParticles() {
  ...
  return (
    <>
      ...
      <mesh geometry={flakeGeometry} count={PARTICLE_COUNT} frustumCulled={false} layers-mask={DYNAMIC_LAYER_MASK}>
      ...
      <mesh geometry={flakeGeometry} count={PARTICLE_COUNT} frustumCulled={false} layers-mask={STATIC_LAYER_MASK}>
        <meshStandardNodeMaterial
          color={0xeeeeee}
          roughness={0.9}
          metalness={0}
