// The two ShaderToy fragment shaders the original embeds as `<script type="x-shader/x-fragment">`
// blocks, verbatim. They are never compiled as GLSL — three's Transpiler reads them and
// emits TSL, which the WebGPU backend then compiles to WGSL.
...
/** Flame gradient — https://www.shadertoy.com/view/3tcBzH */
